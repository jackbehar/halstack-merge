...
// type DxcResultsetTablePropsType = React.ComponentProps<typeof DxcResultsetTable>;

/**
 * @uxpindocurl https://developer.dxc.com/halstack/9/components/accordion/
 */
export default function ResultsetTable(props: DxcResultsetTablePropsType) {
  return <DxcResultsetTable {...props} />;
}
...
type DxcResultsetTablePropsType = {
  /**
